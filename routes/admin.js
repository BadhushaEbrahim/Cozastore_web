...
const {
  ...
  UnBlockUser,
  ViewAllUserOrders,
  adminProductWiseOrders,
  setPorductOrderStatus,
  viewAdminBanners,
  addBanners,
  postBannerIn,
  geteditBannerPage,
  postEditBannerDetails,
  showCouponsPage,
  addCoupons,
  postCoupons,
  getOffersList,
  ...
  getAdminYearlySalesReport,
  getAdminDailySalesReport,
...
router.post(
  "/addCatogories",
  categoryupload.uploadcategory.array("categoryimage"),
  addCategoryIn
);
